    ...
    <div class="container">
        <footer class="py-3 my-4">
            <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                ...
                <li class="nav-item"><a href="addemployee.jsp" class="nav-link px-2 text-body-secondary">Add Employee</a></li>
            ...
            <p class="text-center text-body-secondary">Employee © 2025 Company Limited</p>
        </footer>
    </div>
</div>
